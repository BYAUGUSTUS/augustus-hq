...
export default function ArchitectDossier() {
  return (
    <div className="w-full min-h-screen bg-[#000000] relative z-20 px-4 sm:px-8 md:px-12 lg:px-16 xl:px-20 pt-16 sm:pt-20 md:pt-24 pb-8 font-mono select-none flex flex-col justify-between border-y border-[#27221E] overflow-y-auto">
      ...
      <div className="w-full flex-1 flex flex-col justify-center pb-6 my-auto">
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-4 flex flex-col items-center justify-center">
            <div className="relative w-full aspect-square max-w-[280px] sm:max-w-[320px] md:max-w-[360px] lg:max-w-full border border-[#3A312A] bg-[#0A0A0C] overflow-hidden group shadow-2xl rounded-sm">
              <div
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(to bottom, rgba(200,162,122,0.2) 1px, transparent 1px)",
          ...
          <div className="lg:col-span-8 flex flex-col justify-center py-2">
            <div>
              <div className="flex items-center gap-2 text-[#C8A27A] text-xs sm:text-sm uppercase tracking-wider mb-2 font-bold">
      ...
      {/* BOTTOM SECTION: 2 Floating Camel (#C8A27A) Cards */}
      <div className="w-full pt-4 shrink-0">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 font-sans text-xs sm:text-sm leading-relaxed">
          
          {/* Column 1: Hardware & Physical Actuation */}
          <div className="p-5 sm:p-6 rounded-xl bg-[#C8A27A] text-[#1C1917] shadow-[0_12px_36px_rgba(0,0,0,0.7)] flex flex-col justify-between transition-transform duration-300 hover:-translate-y-1">
            <div className="font-mono text-xs sm:text-sm text-[#451A03] font-bold tracking-wider uppercase mb-2">
              01 // PHYSICAL MECHATRONICS &amp; ACTUATOR ENGINEERING
            </div>
            <p className="font-extrabold text-[#0C0A09] mb-2">
              BUILDING THE MACHINE FROM FIRST PRINCIPLES.
            </p>
            <p className="mb-2 text-[#292524] text-xs sm:text-sm font-medium">
            ...
            <p className="text-[#292524] text-xs sm:text-sm font-medium">
      ...
      {/* FOOTER ACTION BAR */}
      <div className="mt-4 pt-3 border-t border-[#27221E] flex items-center justify-end text-xs text-[#A89887] gap-4 font-mono shrink-0">
        <div className="flex items-center gap-2">
          <span className="text-[#71685F]">ECOSYSTEM:</span>
          <span className="text-[#C8A27A] font-bold">[BY AUGUSTUS // 2026]</span>
        </div>
      </div>
